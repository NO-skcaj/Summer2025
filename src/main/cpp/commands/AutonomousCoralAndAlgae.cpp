...
{
    AddCommands(AutonomousOneCoralAprilTag(gripperPoseEnum, getStartingPosition, getParameters, drivetrain, gripper),  // Do all the coral stuff
                ChassisDrivePose(getParameters().Speed, -24.0_in, 0.0_m, 0.0_deg, 15_s, drivetrain),                   // Move robot away from reef
                AprilTagDriveToAlgae(GripperPoseEnum::AlgaeHigh, gripper, drivetrain),                                 // Drive to the reef for Algae
