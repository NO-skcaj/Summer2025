...
namespace ActivateConstants
{
    ...
    constexpr auto Coral123GripperPlaceWait       =  1.0_s;
    ...
    constexpr auto Coral4GripperPlaceWait         = 1.0_s;
    ...
    constexpr auto AlgaeProcessorGripperPlaceWait = 0.0_s;
    ...
    constexpr auto AlgaeBargeGripperPlaceWait     = 0.0_s;
